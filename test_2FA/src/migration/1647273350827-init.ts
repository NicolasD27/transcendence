...
export class init1647273350827 implements MigrationInterface {
    name = 'init1647273350827'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "salt" character varying NOT NULL, "hashedRefreshToken" character varying, "twoFactorAuthSecret" character varying, "isTwoFactorEnable" boolean NOT NULL DEFAULT false, "userInfoId" integer, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "REL_5c634c605ff93c4ac0f1be62f0" UNIQUE ("userInfoId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
